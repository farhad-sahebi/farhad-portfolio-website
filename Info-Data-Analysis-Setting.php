		...
		<?php
        	if ($result->num_rows>0) {
        			while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . htmlspecialchars($row['slide_title']) . "</td>";
                            echo "<td><a href='delete_data-analysis_.php?id=" . $row['ID'] . "' class='btn btn-info'>Delete</a></td>";
                            echo "<td><a href='Info-Data-Analysis-Setting_update.php?id=" . $row['ID'] . "' class='btn btn-light'>Edit</a></td>";
                            echo "</tr>";
                        }
                    } else {
