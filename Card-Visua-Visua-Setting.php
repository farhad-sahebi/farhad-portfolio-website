		...
		<?php
        	if ($result->num_rows>0) {
        			while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='delete_card_visu.php?id=" . $row['id'] . "' class='btn btn-info'>Delete</a></td>";
                            echo "<td><a href='Card-Visua-Visua-Setting_update.php?id=" . $row['id'] . "' class='btn btn-light'>Edit</a></td>";
                            echo "</tr>";
                        }
                    } else {
